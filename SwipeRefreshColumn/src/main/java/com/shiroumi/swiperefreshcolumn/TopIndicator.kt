...
internal fun getDefaultTopIndicator(): TopIndicator = TopIndicator { isRefreshing ->
    DefaultTopIndicator(isRefreshing = isRefreshing)
}

@ExperimentalAnimationApi
@Composable
private fun DefaultTopIndicator(isRefreshing: Boolean) {
    ...
    LaunchedEffect(isRefreshing, endAngle) {
    ...
    LaunchedEffect(isRefreshing, startAngle) {
